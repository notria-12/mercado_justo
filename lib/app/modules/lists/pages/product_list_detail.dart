                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Observer(builder: (_) {
                              ...
                              return FutureBuilder(
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState ==
                                    ...
                                    return Visibility(
                                      visible: storeFairPrice
                                          .fairPricesFromList.isNotEmpty,
                                      child: Column(
                                        children: [
                                          RichText(
                                              text: TextSpan(
                            ...
                            return Visibility(
                              visible: storeProductList
                                      .missingProducts['missingItens'] !=
                                  0,
                              child: Column(
                                children: [
                                  RichText(
                                ...
                                if (storeProductList.marketSelected == -1) {
                                  ...
                                  return Container(
                                    ...
                                    child: Image.network(storeMarket
                                        .markets[
                                            storeProductList.marketSelected]
                                        .imagePath!),
                                  );
                                }
                              }),
